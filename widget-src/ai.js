/*
 * Lovingly borrowed from https://github.com/zeyu2001/chess-ai/blob/main/js/main.js.
 */
 ...
 */
export function getBestMove(game, color) {
    positionCount = 0;
    ...
    console.log(`${positionCount} positions evaluated in ${moveTime / 1000}s. That's ${Math.round(positionsPerS)} positions / s.`)
